...
Vue.js · Astro · TypeScript · .NET · PostgreSQL · SaaS/ERP · AI-assisted development

I'm a recently graduated **Web Application Development (DAW)** student based in Valencia, Spain, with practical experience in modern frontend development inside a real **SaaS/ERP environment**.

During my internship at **Beply Technologies**, I worked on the evolution of the company's corporate website, collaborating on a migration from **Nuxt.js / Vue.js** to **Astro**, improving structure, responsive design, performance, semantic layout and user experience.

I’m especially interested in building useful digital products, internal tools, SaaS platforms, automation systems and business-oriented web applications.
...
- 💻 Practical experience in a real **SaaS/ERP company**
- 🧩 Interested in **full stack development**, product-oriented software and business process automation
- 🛠 Working with modern web technologies such as **Vue.js, Astro, TypeScript, React, .NET and PostgreSQL**
...
### Beply Technologies — Web Development Internship

Beply is a SaaS/ERP platform for companies, freelancers and consulting firms, with modules for business management, ecommerce integrations, marketplace connectors and AI-assisted features.

During my internship, I worked on the evolution of the corporate website and collaborated in a technological migration from **Nuxt.js / Vue.js** to **Astro**.

Main contributions:

- Developed and adapted frontend components for a real corporate website
- Collaborated on the migration from **Nuxt.js / Vue.js** to **Astro**
- Improved responsive layout, visual structure and content organization
- Applied basic SEO, semantic HTML and accessibility principles
...
- Study mode for working with transcriptions
